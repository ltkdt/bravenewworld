# Generated by Django 5.2.6 on 2025-10-28 15:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='RasterMap',
            fields=[
                ('raster_id', models.AutoField(default=1, primary_key=True, serialize=False)),
                ('name', models.CharField(default='Raster overlay on Folium map', max_length=255)),
                ('date_taken', models.DateField(blank=True, null=True)),
                ('bounds', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(blank=True, null=True), blank=True, null=True, size=None)),
                ('map_center', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(blank=True, null=True), blank=True, null=True, size=None)),
                ('image', models.ImageField(blank=True, null=True, upload_to='png_raster/')),
                ('colormap', models.ImageField(blank=True, null=True, upload_to='color_map/')),
